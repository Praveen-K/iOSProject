...
perl extract.pl /Users/GSPANN/Jenkins/jobs/Ios_Build_CI/workspace/iphone/konyappiphone.KAR
open ../VMAppWithKonylib.xcodeproj

cd /Users/GSPANN/Desktop/VMAppWithKonylib
xcodebuild -target "KRelease" -scheme "KRelease" -configuration Debug
